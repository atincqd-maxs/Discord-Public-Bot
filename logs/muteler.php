...
<div class="main-content">
    ...
    <div class="filters">
         <div class="filter-group">
            <label for="muteTypeFilter">Mute Tipi:</label>
            <select id="muteTypeFilter" class="filter-select">
                <option value="voicemute,chatmute">Tümü</option>
                <option value="voicemute">Ses Mute</option>
                <option value="chatmute">Chat Mute</option>
            </select>
        </div>
        <div class="filter-group">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        loadUserFilterData();
        loadLogs(document.getElementById('muteTypeFilter').value, 1);

        document.getElementById('muteTypeFilter').addEventListener('change', () => {
             loadLogs(document.getElementById('muteTypeFilter').value, 1);
        });
    });
</script>
