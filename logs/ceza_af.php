...
<title>Ceza Affetme Logları</title>
...
<div class="main-content">
    <h1>Ceza Affetme Logları</h1>

    <div class="filters">
         <div class="filter-group">
            <label for="moderatorFilter">Affeden Yetkili:</label>
            <select id="moderatorFilter" class="filter-select">
...
<script src="js/af-loglari.js"></script>
