    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-category">
            ...
            <div class="submenu show">
                ...
                <a href="uyari_log.php" class="active">
...
<div class="main-content">
    <h1>Uyarı Logları (.uyari1 / .uyari2)</h1>

    <div class="filters">
         <div class="filter-group">
            <label for="uyariTipiFilter">Uyarı Tipi:</label>
            <select id="uyariTipiFilter" class="filter-select">
                <option value="all">Tümü</option>
                <option value="uyari1">Uyarı 1</option>
                <option value="uyari2">Uyarı 2</option>
            </select>
        </div>
        <div class="filter-group">
...
<script src="js/uyari-loglari.js"></script>
